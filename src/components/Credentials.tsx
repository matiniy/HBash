        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <p className="text-white text-sm mb-2">Haideh Bashash</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <p className="text-white text-sm mb-2">HomeSmart Stars</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <p className="text-white text-sm mb-2">9+ Years</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <p className="text-white text-sm mb-2">Direct Access</p>
