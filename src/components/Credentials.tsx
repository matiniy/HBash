    ...
    <section className="py-20 bg-deep-forest relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-8 sm:mb-12 lg:mb-16">
          {/* License Card */}
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Licensed Realtor</h3>
              <p className="text-white text-xs sm:text-sm mb-2">Haideh Bashash</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Brokerage</h3>
              <p className="text-white text-xs sm:text-sm mb-2">HomeSmart Stars</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <p className="text-white text-xs sm:text-sm mb-2">9+ Years</p>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-gray-700/50 hover:border-aqua-neon/50 transition-all duration-300 group">
            <div className="text-center">
              ...
              <p className="text-white text-xs sm:text-sm mb-2">Direct Access</p>
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16 text-center">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm text-white px-2">
