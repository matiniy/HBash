      ...
      <div className={`w-full ${innerPadding} nav-inner`}>
        <div className={`flex w-full items-center ${barHeight}`}>
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            <a href="https://www.instagram.com/haideh.realty/" target="_blank" rel="noopener noreferrer" className="nav-social-icon text-white/90 hover:text-aqua-neon transition-colors p-1" aria-label="Instagram">
            ...
            <a href="https://www.facebook.com/HaidehBashashRealtor" target="_blank" rel="noopener noreferrer" className="nav-social-icon text-white/90 hover:text-aqua-neon transition-colors p-1" aria-label="Facebook">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/in/haideh-bashash-21119843/" target="_blank" rel="noopener noreferrer" className="nav-social-icon text-white/90 hover:text-aqua-neon transition-colors p-1" aria-label="LinkedIn">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
