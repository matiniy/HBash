        ...
        <div className="space-y-4 sm:space-y-6 text-white leading-relaxed text-sm sm:text-base">
          ...
          <div>
            ...
            <a 
              ...
              className="text-aqua-neon hover:text-[#2B8097] underline transition-colors"
            >
              WWW.TREC.TEXAS.GOV
            </a>
          </div>
          ...
          <div className="pt-6 border-t border-aqua-neon/20">
            ...
            <p className="mt-2">
              <a 
                href="tel:5129363000" 
                className="text-aqua-neon hover:text-[#2B8097] transition-colors"
              >
                (512) 936-3000
              </a>
            </p>
          ...
          <div className="text-xs text-white pt-4 border-t border-aqua-neon/10">
            <p>CN 1-5</p>
            <p className="mt-2">
