          ...
          <div className={`about-section-animate about-section-right space-y-4 sm:space-y-5 ${language === 'fa' ? 'font-sora' : ''} ${isInView ? 'about-section-visible' : ''}`} dir={language === 'fa' ? 'rtl' : 'ltr'}>
            ...
            <div className="flex flex-row flex-wrap gap-3 sm:gap-4 items-center pt-1">
              ...
              <Link href="https://t.me/KasboKarDallas" target="_blank" rel="noopener noreferrer">
                <button className="about-telegram-btn min-h-[48px] h-12 min-w-[180px] sm:min-w-[200px] px-4 xs:px-6 py-2.5 xs:py-3 bg-[#F3D4B4] rounded-[10px] border border-[#144552]/15 hover:bg-[#93B3BB] hover:border-[#93B3BB] hover:text-white transition-all duration-300 flex items-center gap-2 justify-center text-xs xs:text-sm font-medium">
