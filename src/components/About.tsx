      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-8 lg:py-12">
          ...
          <div className="relative w-full shrink-0">
            ...
            />
            <div className="absolute bottom-4 left-4 right-4 sm:left-6 sm:right-6 flex flex-row gap-0 items-stretch">
              <Link href="/contact" className="flex-1 min-w-0">
                <Button variant="primary" className="w-full rounded-l-[10px] rounded-r-none min-h-[48px] h-12 justify-center">
              ...
              <Link href="https://t.me/KasboKarDallas" target="_blank" rel="noopener noreferrer" className="flex-shrink-0">
                <button className="h-12 min-h-[48px] px-4 xs:px-6 py-2.5 xs:py-3 bg-black/30 text-white rounded-r-[10px] hover:rounded-r-[10px] border border-l-0 border-white/20 hover:bg-black/40 transition-all duration-300 flex items-center gap-2 justify-center text-xs xs:text-sm">
